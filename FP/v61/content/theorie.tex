...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.45]{Abbildungen/schemalaser.png}
...
\begin{align*}
    I(r) = I_0 \text{exp}\Biggl(\frac{-2r^2}{\omega^2}\Biggr)
\end{align*}
besitzt. Moden, die höher als die Grundmode sind, werden als Multimode bezeichnet. Diese führen zu unregelmäßiger Lichtintensität im Strahlprofil und schlechterer Strahlqualität.\\
Eine Modenblende wird dazu benutzt um alle transversalen Moden außer der TEM$_{00}$-Mode zu unterdrücken. Dabei wird die spektrale Breite verkleinert und die Unschärfe verringert.
