...
mit Kaliumkationen und Bromidanionen besteht. Die Proben wurde mit zweifach positiv geladenen Strontiumionen (Sr) dotiert, sodass sich
...
\subsubsection{Verwendung des gesamten Kurvenverlaufs}
        ...
        \end{equation}
        Die Änderung Polarisation $\frac{dP}{dt}$ entspricht der Stromdichte $I(T)$ und mit $P = \int \text{d}P$ ist dann
        \begin{equation}
