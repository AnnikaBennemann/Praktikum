...
\label{subsec:KriDi}
Ionenkristalle sind Festkörper aus Ionenbindungen.
Bei höheren Temperaturen kommt es Ionenwanderung, aufgrund der Energiezufuhr.\\
...
Dazu wird Gleichung \ref{eqn:lang} nach der Temperatur abgeleitet um eine Beziehung zwischen $T_text{max}$ und $\tau(T_\text{max})$ herzustellen.
