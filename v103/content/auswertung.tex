...
Aus der gemessenen Länge L_r= , des Durchmessers d_r=  und der bestimmten Masse m_r= des Stabes wir die Dichte des Materials zu \rho = bestimmt.
Aus dem Vergleich mit Literaturwerten \cite{} wird klar, dass es sich um Aluminium handelt.

Außerdem wird das Flächenträgheitsmoment des Stabes bestimmt. Bei einem runden Querschnitt wird dafür die Formel... verwendet.
...
Wie auch beim runden Stab, wird aus der gemessenen Länge L_e=..., der Breite B=... und der Masse m_e die Dichte des Stabs durch rho=.. bestimmt.
Auch bei diesem Stab handelt es sich um Aluminium.

Das Flächenträgheitsmoment des eckigen Stabes mit quadratischem Querschnitt berechnet sich nach der Formel ...
zu ...
