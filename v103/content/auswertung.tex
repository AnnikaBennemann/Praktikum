...
Aus der gemessenen Länge $L_{\text{r}}$ , des Durchmessers $d_{\text{r}}$ und der bestimmten Masse $m_{\text{r}}$ des Stabes wir die Dichte des Materials zu \rho = bestimmt.
...
Wie auch beim runden Stab, wird aus der gemessenen Länge $L_{\text{e}}$ der Breite $b_{\text{e}}$ und der Masse $m_{\text{e}}$ die Dichte des Stabs durch $\rho_{\text{e}}=$ bestimmt.
