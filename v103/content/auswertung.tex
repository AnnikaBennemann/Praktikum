...
\begin{table}
  ...
  \begin{tabular}{S[table-format=3.0]
      ...
      S[table-format=3.1]}
    \toprule
    & \multicolumn{4}{c}{Runder Stab} & \multicolumn{4}{c}{Eckiger Stab} \\
    \cmidrule(lr){0-5} \cmidrule(lr){6-10}
    {$l\mathbin{/}\si{mm}$} & {$l_{Lit}\mathbin{/}\si{mm}$} & {$h\mathbin{/}\si{mm}$} & {$m\mathbin{/}\si{g}$} & {$m_{Lit}\mathbin{/}\si{g}$} & {$l\mathbin{/}\si{mm}$} & {$l_{Lit}\mathbin{/}\si{mm}$} & {$h\mathbin{/}\si{mm}$} & {$m\mathbin{/}\si{g}$} & {$m_{Lit}\mathbin{/}\si{g}$} \\
    \midrule
    500&591,18&10&167,2&164&592&551,92&10&129,4&120,9\\
    \bottomrule
  \end{tabular}
\end{table}
