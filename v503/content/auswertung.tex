...
\begin{table}[H]
        ...
        \label{tab:werte}
        \sisetup{table-format=1.3}
        \begin{tabular}{S S[table-format=2.2] S[table-format=1.4] S[table-format=1.2] @{${}\pm{}$} S[table-format=1.2] S[table-format=1.2] @{${}\pm{}$} S[table-format=1.2] S[table-format=1.2] @{${}\pm{}$} S[table-format=1.2]}
        \toprule
